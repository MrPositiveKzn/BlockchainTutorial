...
func TestNewMerkleNode(t *testing.T) {
	...
	n1 := core.NewMerkleNode(nil, nil, data[0])
	n2 := core.NewMerkleNode(nil, nil, data[1])
	n3 := core.NewMerkleNode(nil, nil, data[2])
	n4 := core.NewMerkleNode(nil, nil, data[2])

	// Level 2
	n5 := core.NewMerkleNode(n1, n2, nil)
	n6 := core.NewMerkleNode(n3, n4, nil)

	// Level 3
	n7 := core.NewMerkleNode(n5, n6, nil)
